...
export class AdminCarCardComponent extends UpdateEntityPage<Car> {
  constructor(
    ...
    super(service, routerActivated, inputs, { formBuilder, changeDetectorRef, dialog, snackBar });
  }
}
...
//   changeDetection: ChangeDetectionStrategy.OnPush,
// })
// export class AdminCarCardComponent extends UpdateEntityPage<Car> implements OnInit, OnDestroy {
//   car: ICar;
//   showSpinner: boolean;
//   carForm: FormGroup;
//   progressValue = 0;
